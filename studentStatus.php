...
$link=mysqli_connect("localhost","root","","scholarship");
if(isset($_POST['submit']))
{
    ...
    $qry="INSERT INTO `studentstatus`(`id`, `name`, `registration_no`, `course`, `status`) VALUES ('','$name','$registration_no','$course','$status')";
